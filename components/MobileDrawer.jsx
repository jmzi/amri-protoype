...
export default function MobileDrawer() {
  ...
  return (
    <>
      <div className="mob-overlay" id="mobOverlay" onClick={closeDrawer}></div>
      <div className="mob-drawer" id="mobDrawer">
        ...
        <div className="mob-socials">
          <a href="#" className="mob-social" title="GitHub">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
          ...
          <a href="#" className="mob-social" title="LinkedIn">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
          ...
          <a href="#" className="mob-social" title="Facebook">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
